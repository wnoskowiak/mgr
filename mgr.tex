...
\tytulang{Klasyfikacja oddziaływań neutrin w ciekłoargonowych komorach projekcji czasowej przy użyciu sieci neuronowych}

\kierunek{Physics (Studies in English)}

\opiekun{\\dr hab. Katarzyna Grzelak\\ Institute of Experimental Physics\\ Faculty of Physics, University of Warsaw\\\vspace{0.3cm plus 1.5fill}\\dr hab. Artur Kalinowski, prof. UW\\ Institute of Experimental Physics\\ Faculty of Physics, University of Warsaw \\}
