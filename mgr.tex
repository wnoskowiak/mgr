...
\fancyfoot[LO,RE]{\thepage} % Put page number on the right in footer
...
\tytulang{Klasyfikacja zdarzeń w komorach projekcyjnych z ciekłym argonem przy użyciu metod uczenia maszynowego}
...
\keywords{deep learning, convolutional neural networks, transformers, neutrino classification, LArTPC, MicroBooNE, AlexNet, LeNet, image classification}
